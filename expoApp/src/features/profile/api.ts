...
export async function updateMe(body: UpdateMeRequest): Promise<UserMeResponse> {
  ...
  if (error || !data) throw apiErrorFromResponse(error, response, "保存に失敗しました");
  return data;
}
...
export async function putAvatar(file: UploadFile): Promise<{ avatarUrl: string }> {
  ...
  if (error || !data)
    throw apiErrorFromResponse(error, response, "画像のアップロードに失敗しました");
  return data;
}
...
export async function deleteAvatar(): Promise<void> {
  ...
  if (error) throw apiErrorFromResponse(error, response, "画像の削除に失敗しました");
}
...
export async function deleteAccount(): Promise<void> {
  ...
  if (error) throw apiErrorFromResponse(error, response, "アカウントの削除に失敗しました");
}
