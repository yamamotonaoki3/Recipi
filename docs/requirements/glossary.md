...
| 閲覧履歴 | 最近見たレシピの一覧。レシピ詳細を開くとサーバーに記録され（`recipe_views`、レシピごとに 1 行・最後に見た時刻で並ぶ）、同じアカウントなら端末をまたいで見える。入口はホームのアプリバーの履歴アイコン。[features/view-history.md](features/view-history.md) 参照 |
