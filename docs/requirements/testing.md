...
| feed p50 / p95 / p99 | 未測定 | 未測定（30 VU 区間 / 45 VU 区間を分けて書く） | 未測定（急増中 / 回復区間を分けて書く） |
| search p50 / p95 / p99 | 未測定 | 未測定（同上） | 未測定（同上） |
| detail p50 / p95 / p99 | 未測定 | 未測定 | 未測定 |
| RPS（1 秒あたりのリクエスト数） | 未測定 | 未測定 | 未測定 |
| 失敗率 / 5xx 件数 | 未測定 | 未測定 | 未測定（エラーの内訳も書く） |
| 最初に詰まった箇所 | — | 未測定 | — |
| 回復までの時間 | — | — | 未測定 |
| 判定 | 未測定 | 未測定 | 未測定 |
