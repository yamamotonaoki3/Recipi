...
| Phase 4 | ボトムナビゲーション / ナビゲーションレール（4 destination）＋ ホーム「全体」タブ ＋ ホーム上部の常時固定検索窓（`q`、スペース分割・正規化、表示中サブタブ内で絞り込み） | [screens/navigation.md](screens/navigation.md), [screens/home.md](screens/home.md), [features/home-feed.md](features/home-feed.md), [features/search.md](features/search.md) |
