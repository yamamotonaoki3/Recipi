...
要件定義書は機能ごとに分割し、[docs/requirements/](requirements/) に移動しました。

まずは **[docs/requirements/README.md](requirements/README.md)**（目次）を参照してください。

- 全体像・ユースケース: [requirements/overview.md](requirements/overview.md)
- 用語集: [requirements/glossary.md](requirements/glossary.md)
- 各機能: [requirements/features/](requirements/features/)
